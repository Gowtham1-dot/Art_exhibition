...
1. Open `/upload`
2. Upload an artwork + metadata
3. Artwork is saved as **pending** until a curator approves it

### Curator flow

1. Open `/curator`
2. Login using `CURATOR_PIN`
3. Approve uploaded artworks (so they can be used publicly and for AI grouping)
4. Click **Generate** to create AI suggestions
5. For any suggestion, click **Review / Edit** to open the inline draft editor
6. Publish the exhibition when it looks correct
